...
<br>
<center>
<font face="Courier New" font size="20" <h1>REKOD PESAKIT</h1></font><br><br>
<?php
include('config.php');
$sql="SELECT * from rekodpesakit ORDER BY idpesakit";
...
<th align="center"><strong> Jenis Penyakit </strong></th>
<th align="center"><strong>Tarikh</strong></th>
<th align="center"><strong>Nama Ubat</strong></th>
...
while($row=mysql_fetch_array($result))
{
  ...
  echo"<td>".$row["jenispenyakit"]."</td>";
  echo"<td>".$row["tarikh"]."</td>";
  echo"<td><center>".$row["nama_ubat"]."</td>";
